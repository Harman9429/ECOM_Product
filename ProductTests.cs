    ...
    public class ProductTest
        {
            ...
            public void Setup()
            {
                _product = new Product(1, "furniture", 100, 100);
            ...
            {
                //Arrange 
                Product New_Product = new Product(id, "toys", 10, 10);
            ...
            {
                //Arrange 
                Product New_Product = new Product(1, "toys", price, 100);
            ...
            {
                //Arrange 
                Product New_Product = new Product(1, "clothes", 11, stock);
